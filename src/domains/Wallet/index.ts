...
export default class Wallet {
  ...
  private constructor({
    ...
    this.type = type;
    this.signer = signer;
    this.accountManager = new AccountManager(accounts, activeAccount ?? null);
  }
  ...
  public isPasswordValid(passwordProvider: SecretsProvider): Promise<boolean> {
  ...
  public static async importKeyfile(
    ...
    const secretProvider: SecretsProvider = new SecretsProvider(() => secret);
